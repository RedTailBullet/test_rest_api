...
const c: TestCase = {
  description: '6. Update product type change attribute definition\'s label',
  ...
  requestData: {
    payload: {
      ...
      'actions': [
        {
          'action': 'changeLabel',
          'attributeName': 'normal-test-attribute-definition-text',
          'label': { 'en': 'normal test attribute definition text changed' }
        }
      ]
    }
  },
      ...
      'attributes': [
        {
          ...
          'label': {
            'en': 'normal test attribute definition text changed'
          },
          'isRequired': true,
          'type': {
            'name': 'text'
