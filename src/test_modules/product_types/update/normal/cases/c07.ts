...
const c: TestCase = {
  description: '7. Update product type set inputTip',
  ...
  requestData: {
    payload: {
      ...
      'actions': [
        {
          'action': 'setInputTip',
          'attributeName': 'normal-test-attribute-definition-enum',
          'inputTip': { 'en': 'input tip for normal test attribute definition enum' }
        }
      ]
    }
  },
    ...
    data: {
      ...
      'attributes': [
        ...
        },
        {
          ...
          'inputTip': {
            'en': 'input tip for normal test attribute definition enum'
          },
          'attributeConstraint': 'None',
          'isSearchable': true,
          'inputHint': 'SingleLine',
