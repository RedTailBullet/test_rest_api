...
const c: TestCase = {
  description: '10. Update product type change attribute order',
          ...
          'attributes': [
            {
              ...
              'label': { 'en': 'normal test attribute definition text' },
              'isRequired': true,
            ...
            },
            {
              ...
              'label': { 'en': 'normal test attribute definition lenum' },
              'isRequired': true,
              'attributeConstraint': 'None',
              'inputHint': 'SingleLine',
              'isSearchable': true
            },
            {
              ...
              'label': { 'en': 'normal test attribute definition enum' },
              'isRequired': false,
              'attributeConstraint': 'None',
              'inputHint': 'SingleLine',
              'isSearchable': true
